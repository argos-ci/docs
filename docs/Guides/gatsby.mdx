...
```bash
yarn add -D gatsby-plugin-argos argos-cli gatsby-plugin-screenshot puppeteer
```
...
> Click to read the [example repository](https://github.com/argos-ci/argos-example-gatsby-github-actions).
