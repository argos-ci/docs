...
Argos allows you to give a name to identify a build. It allows to create multiple builds for a same commit.

Give a name to your build using `--build-name` argument. In this example we create one build for components and another for E2E.
