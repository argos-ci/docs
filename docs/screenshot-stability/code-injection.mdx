...
It can be convenient to inject Javascript in a page to ensure the screenshots' consistency.

For example, the screenshot could be taken when the assets are not fully loaded a induce flaky test.
