...
GitHub Actions `merge_group` runs are detected automatically. If you use a different merge queue system, you can opt in manually by setting `ARGOS_MERGE_QUEUE_PRS` to the comma-separated pull request numbers included in the queued build.
