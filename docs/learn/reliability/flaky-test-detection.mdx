...
sidebar_position: 1
description: Argos marks unstable tests with a flaky badge and history view, helping you judge reliability with stability scores and detailed context.
---
...
![Auto-ignore flaky changes in project settings](./flaky-test-detection/auto-ignore.png)
