...
Discover how to implement CSS that is specifically evaluated during the screenshot process with Argos.
...
All our SDKs supports an `argosCSS` options that allows you to specify custom CSS evaluated during the screenshot process. The style will be removed from the page after the screenshot is taken.
