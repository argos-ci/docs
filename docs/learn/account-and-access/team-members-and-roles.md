...
* [Team level roles](team-members-and-roles.md#team-level-roles): Users who have access to all projects within a team
  * [Owner](team-members-and-roles.md#owner-role)
  * [Member](team-members-and-roles.md#member-role)
  * [Contributor](team-members-and-roles.md#contributor-role)
...
* [**Owner**](team-members-and-roles.md#owner-role) and [**Member**](team-members-and-roles.md#member-role): Have the highest level of control. They can manage, modify, and oversee the team's settings, and all projects
* [**Contributor**](team-members-and-roles.md#contributor-role): A unique role that can be configured to have any of the project level roles or none. If a contributor has no assigned project role, they won't be able to access that specific project. Only contributors can have configurable project roles
...
* Review builds and edit project settings — _Depending on their assigned_ [_project role_](team-members-and-roles.md#project-level-roles)

**Access and permissions**

Contributors can be assigned to specific projects and have the same permissions as [project administrators](team-members-and-roles.md#project-administrator), [project reviewers](team-members-and-roles.md#project-reviewer), or [project viewers](team-members-and-roles.md#project-viewer). They can also be assigned no project role, which means they won't be able to access that specific project.

See the [Project level roles](team-members-and-roles.md#project-level-roles) section for more information on project roles.
...
* [**Project Administrator**](team-members-and-roles.md#project-administrator): Team owners and members inherently act as project administrators for every project. Project administrators can review builds, manage all project settings, and manage production environment variables
* [**Project Reviewer**](team-members-and-roles.md#project-reviewer): Can review builds.
* [**Project Viewer**](team-members-and-roles.md#project-viewer): Has read-only access to a specific project.
