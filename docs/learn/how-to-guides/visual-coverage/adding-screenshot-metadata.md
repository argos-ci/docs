...
| `viewport`          | [Viewport](adding-screenshot-metadata.md#viewport)?                    | The viewport dimensions when the screenshot was taken.                                 |
...
| `test`              | [Test](adding-screenshot-metadata.md#test)?                            | Information about the test that generated the screenshot.                              |
| `browser`           | [Browser](adding-screenshot-metadata.md#browser)?                      | The browser that generated the screenshot.                                             |
| `automationLibrary` | [Automation Library](adding-screenshot-metadata.md#automation-library) | The automation library that generated the screenshot. _(Required)_                     |
| `sdk`               | [SDK](adding-screenshot-metadata.md#sdk)                               | The Argos SDK that generated the screenshot. _(Required)_                              |
...
* `location` ([Location](adding-screenshot-metadata.md#location)?): Where the test is located in the source code.
...
* `annotations` ([Test Annotation](adding-screenshot-metadata.md#test-annotation)\[]?): Extra information about the test.
...
* `location` ([Location](adding-screenshot-metadata.md#location)?): Where the annotation is located in the source code.
