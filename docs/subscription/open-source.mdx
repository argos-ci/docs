...
import { ArgosBanner } from "@site/src/components/ArgosBanner";
...
3. Send us an email at [contact@argos.com](contact@argos.com). In the email, confirm that your project meets all the sponsorship criteria and explain why the free tier of Argos doesn't cover your project's needs. Please include your Argos team slug and a link to your open source repository in the email.
