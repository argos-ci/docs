...
** Static sites ** : we provide plugins to automatically take screenshots of all pages and upload them on Argos. Visit our guides to check if your stack match our integrations.

### Notify change detection

Once [installed](/getting-started), Argos receives screenshots from the Continuous Integration (CI) workflow.
