...
Visual testing is the process of comparing application UI with the results expected by design or with the previous state of the application. Automated visual testing tools, like Argos, allow monitoring the application's UI on multiple browsers and screen sizes.
