...
Argos notifies you directly on your GitHub pull-request by adding a status check. If a no change are detected, the status is ✅ Pass, everything's good, you can merge your pull-request with confidence.
