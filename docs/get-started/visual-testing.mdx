...
Argos visual testing is based on screenshot comparison change detection and manual review. With this process, developers can quickly check the visual impacts of their pull requests, even on a large application.
...
<details>
  ...
  <p>You can choose another reference branch in Argos repository settings.</p>
</details>
