...
import githubWaitingCheckStatus from "@site/static/img/github-waiting-check-status.png";
import githubPassingCheckStatus from "@site/static/img/github-passing-check-status.png";
