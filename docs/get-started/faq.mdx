...
Navigate to your team settings, scroll down to members section, and click on "Invite Link".

Share the team's link with the individuals you want to invite.
...
A reference branch is the branch used as the baseline for the screenshot comparisons. Argos automatically uses the default branch of your GitHub project as the reference branch, but you can set another branch in Argos repository settings.

## How do I change the reference branch?

You can change the reference branch in Argos project settings.
