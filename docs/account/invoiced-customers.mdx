...
If an invoiced GitHub account tries to subscribe to Argos' plan on GitHub Marketplace, the following message will be displayed. However, we offer an alternative payment method through Stripe for these customers.
