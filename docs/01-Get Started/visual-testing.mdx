...
These integrations provide helpful utilities to hide unstable elements from screenshots. Read [screenshot stability](/screenshot-stability) to learn more about this topic.
