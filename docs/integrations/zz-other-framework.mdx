...
For guidance on which code snippets to inject into tested pages before taking screenshots, refer to the [style injection](/style-injection) and [code injection](/code-injection) documentation.
