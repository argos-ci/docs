...
import { InstallCliCommand } from "@site/src/partials";
import TokenStep from "../ci-guides/_token-step.mdx";
...
Argos CLI automatically detects `ARGOS_TOKEN` environment variable. In order to work you have to expose it as environment variable.
