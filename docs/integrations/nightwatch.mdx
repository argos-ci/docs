...
Integrating Argos with [Nightwatch](https://nightwatchjs.org/) to enable visual testing on your application.

You can use Nightwatch to take screenshots of your application. However, we recommend overloading the screenshot command to improve the rendering stability.
